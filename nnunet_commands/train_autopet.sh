...
#SBATCH --job-name=fold_2_continue
...
# nnUNetv2_train 999 3d_fullres 4 -tr autoPET3_Trainer -p nnUNetResEncUNetLPlansMultiTalent -pretrained_weights  /dartfs/rc/lab/B/BhattacharyaI/Results/Bashirul/Research/autopet-3-submission/pretrained/Dataset619_nativemultistem/MultiTalent_trainer_multistems_4000ep__nnUNetResEncUNetL1x1x1_Plans_znorm_bs24__3d_fullres/fold_all/checkpoint_final.pth --npz 
nnUNetv2_train 999 3d_fullres 2 -tr autoPET3_Trainer -p nnUNetResEncUNetLPlansMultiTalent --npz --c
