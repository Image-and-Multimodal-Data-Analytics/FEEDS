...
#SBATCH --job-name=retesting_test-notta    # Descriptive job name
#SBATCH --account=free
#SBATCH --nodes=1                     # Request 1 node
#SBATCH --ntasks-per-node=1          # Number of tasks per node
#SBATCH --gres=gpu:1
#SBATCH --partition=gpuq   # Partition (queue) name on your cluster
#SBATCH --time=1-00:00:00              # Walltime (HH:MM:SS) 
...
nnUNetv2_predict --c -i "/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset999_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/fold_2_mg/test/images" \
                -o "/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset999_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/${fold_name}/test_predictions" \
                -d 999 \
                -tr autoPET3_Trainer \
                -p nnUNetResEncUNetLPlansMultiTalent \
                -c 3d_fullres \
                -chk "/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset999_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/${fold_name}/checkpoint_best.pth" --save_probabilities \
                --disable_tta
