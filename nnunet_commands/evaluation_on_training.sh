...
#SBATCH --job-name=eval_nnu_training    # Descriptive job name
...
for fold in fold_0_10; do
  nnUNetv2_evaluate_folder \
    ...
    /dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset999_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/train_link_labels/ \
    /dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset999_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/${fold}/train_tta_predicted/train_predictions/
done