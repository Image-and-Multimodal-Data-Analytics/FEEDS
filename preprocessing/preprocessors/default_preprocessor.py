...
def example_test_case_preprocessing():
    ...
    plans_file = '/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_processed/Dataset888_AutoPet/nnUNetResEncUNetLPlansMultiTalent.json'
    dataset_json_file = '/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_processed/Dataset888_AutoPet/dataset.json'
    input_images =['/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset888_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/fold_1_ens_comb/DHMC_data/images/002_RES05762_oriented_0000.nii.gz', '/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset888_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/fold_1_ens_comb/DHMC_data/images/002_RES05762_oriented_0001.nii.gz' ]  # if you only have one channel, you still need a list: ['case000_0000.nii.gz']
    output_images = ['/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset888_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/fold_1_ens_comb/DHMC_data_processed/images/002_RES05762_oriented_0000.nii.gz', '/dartfs/rc/lab/B/BhattacharyaI/Results/nnUNet_data/nnUNet_results/Dataset888_AutoPet/autoPET3_Trainer__nnUNetResEncUNetLPlansMultiTalent__3d_fullres/fold_1_ens_comb/DHMC_data_processed/images/002_RES05762_oriented_0001.nii.gz']
    ...
    for (i,d) in enumerate(data):
        print(d)
        sitk.WriteImage(d, output_images[i])

    return data


if __name__ == '__main__':
    processed_data = example_test_case_preprocessing()
