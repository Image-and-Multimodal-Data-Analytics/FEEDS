...
The unified `main.py` supports three modes: `lesion`, `mets`, or `both`. The expected result is generated by "mets" the other two are there, but are legacy. 
