...
class nnUNetDataLoaderBase(DataLoader):
    def __init__(self,
        ...
        self.data_shape, self.seg_shape, self.uncer_shape = self.determine_shapes()
    ...
    def determine_shapes(self):
        # load one case
        #data, seg, properties,_, _ = self._data.load_case(self.indices[0])
        ...
        uncer_shape = (self.batch_size, 1, *self.patch_size)
        return data_shape, seg_shape, uncer_shape
